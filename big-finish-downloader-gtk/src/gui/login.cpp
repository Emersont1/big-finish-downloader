...
libbf::gui::login::login() {
    ...
    g_signal_connect(ok_button, "clicked", G_CALLBACK(&ok_button_activate_cb), this);
    g_signal_connect(cancel_button, "clicked", G_CALLBACK(&cancel_button_activate_cb), this);
    g_signal_connect(window, "destroy", G_CALLBACK(&cancel_button_activate_cb), this);
