...
int main(int argc, char *argv[])
{
    ...
    gtk_builder_add_from_string (builder,
                             (const gchar*)GLADE_LOGIN_STR.data(),
                             GLADE_LOGIN_STR.size(),
                             nullptr);
...
gtk_entry_get_text((GtkEntry*)email_input)<<std::endl<<gtk_entry_get_text((GtkEntry*)password_input)<<std::endl;
}
